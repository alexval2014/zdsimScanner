...
namespace zdsimScanner
{
    class LocoRead
    {
        ...
        //-----------------------------------------------------------------------------------
        public static byte[] read_ep1m_V54_006(int sig_pos_pnevm = 0, int sig_pos_elektro = 0)
        {
            //статические
            //скорость доп.
            Loco.temp_buffer = Loco.read_bytes((Int32)Loco.BA + 0x0032CA78, 2);
        ...
        //-----------------------------------------------------------------------------------
        public static byte[] read_chs2k_V54_006(int sig_pos_pnevm = 0, int sig_pos_elektro = 0)
        {
           //статические
        ...
        //-----------------------------------------------------------------------------------
        public static byte[] read_chs4_V54_006(int sig_pos_pnevm = 0, int sig_pos_elektro = 0)
        {
           //статические
           //скорость доп.
           Loco.temp_buffer = Loco.read_bytes((Int32)Loco.BA + 0x0032CA78, 2);
        ...
        //-----------------------------------------------------------------------------------
        public static byte[] read_chs4kvr_V54_006(int sig_pos_pnevm = 0, int sig_pos_elektro = 0)
        {
           //статические
           //скорость доп.
           Loco.temp_buffer = Loco.read_bytes((Int32)Loco.BA + 0x0032CA78, 2);
        ...
        //-----------------------------------------------------------------------------------
        public static byte[] read_chs4t_V54_006(int sig_pos_pnevm = 0, int sig_pos_elektro = 0)
        {
           //-------------------------------------------------------------------------
           //                               статические
           //-------------------------------------------------------------------------
        ...
        //-----------------------------------------------------------------------------------
        public static byte[] read_chs7_V54_006(int sig_pos_pnevm = 0, int sig_pos_elektro = 0)
        {
           //статические
           //скорость доп.
           Loco.temp_buffer = Loco.read_bytes((Int32)Loco.BA + 0x0032CA78, 2);
        ...
        //-----------------------------------------------------------------------------------
        public static byte[] read_chs8_V54_006(int sig_pos_pnevm = 0, int sig_pos_elektro = 0)
        {
           //статические
           //скорость доп.
           Loco.temp_buffer = Loco.read_bytes((Int32)Loco.BA + 0x0032CA78, 2);
        ...
        //-----------------------------------------------------------------------------------
        public static byte[] read_vl11m_V54_006(int sig_pos_pnevm = 0, int sig_pos_elektro = 0)
        {
           //статические
           //скорость доп.
           Loco.temp_buffer = Loco.read_bytes((Int32)Loco.BA + 0x0032CA78, 2);
        ...
        //-----------------------------------------------------------------------------------
        public static byte[] read_vl82m_V54_006(int sig_pos_pnevm = 0, int sig_pos_elektro = 0)
        {
           //статические
           //скорость доп.
           Loco.temp_buffer = Loco.read_bytes((Int32)Loco.BA + 0x0032CA78, 2);
        ...
        //-----------------------------------------------------------------------------------
        public static byte[] read_vl80t_V54_006(int sig_pos_pnevm = 0, int sig_pos_elektro = 0)
        {
           //-------------------------------------------------------------------------
           //                               статические
           //-------------------------------------------------------------------------
        ...
        //-----------------------------------------------------------------------------------
        public static byte[] read_vl85_V54_006(int sig_pos_pnevm = 0, int sig_pos_elektro = 0)
        {
           //статические
           //скорость доп.
           Loco.temp_buffer = Loco.read_bytes((Int32)Loco.BA + 0x0032CA78, 2);
        ...
        //-----------------------------------------------------------------------------------
        public static byte[] read_tep70_V54_006(int sig_pos_pnevm = 0, int sig_pos_elektro = 0)
        {
           //статические
           //скорость доп.
           Loco.temp_buffer = Loco.read_bytes((Int32)Loco.BA + 0x0032CA78, 2);
        ...
        //-----------------------------------------------------------------------------------
        public static byte[] read_2te10u_V54_006(int sig_pos_pnevm = 0, int sig_pos_elektro = 0)
        {
           //статические
           //скорость доп.
           Loco.temp_buffer = Loco.read_bytes((Int32)Loco.BA + 0x0032CA78, 2);
        ...
        //-----------------------------------------------------------------------------------
        public static byte[] read_m62_V54_006(int sig_pos_pnevm = 0, int sig_pos_elektro = 0)
        {
           //статические
           //скорость доп.
           Loco.temp_buffer = Loco.read_bytes((Int32)Loco.BA + 0x0032CA78, 2);
        ...
        //-----------------------------------------------------------------------------------
        public static byte[] read_ed4m_V54_006(int sig_pos_pnevm = 0, int sig_pos_elektro = 0)
        {
           //статические
           //скорость доп.
           Loco.temp_buffer = Loco.read_bytes((Int32)Loco.BA + 0x0032CA78, 2);
        ...
        public static byte[] read_ed4m_V55_008(int sig_pos_pnevm = 0, int sig_pos_elektro = 0)
        {
            ...
            //читаем контроллер
            byte[] b_temp_byte1 = new byte[1] { 0 };             //обнуляем массив
            b_temp_byte1 = Loco.read_bytes((Int32)Loco.BA + 0x08DB92AD, 1);//читаем контроллер
            Loco.temp_buffer = Loco.read_bytes((Int32)Loco.BA + 0x08DB92AD, 1); //читаем контроллер
            Array.Copy(Loco.temp_buffer, 0, Loco.out_buffer, 15, 1);
        ...
        //-----------------------------------------------------------------------------------
        public static byte[] read_ed9m_V54_006(int sig_pos_pnevm = 0, int sig_pos_elektro = 0)
        {
           //статические
           //скорость доп.
           Loco.temp_buffer = Loco.read_bytes((Int32)Loco.BA + 0x0032CA78, 2);
        ...
        //-----------------------------------------------------------------------------------
        public static byte[] read_tem18_V54_006(int sig_pos_pnevm = 0, int sig_pos_elektro = 0)
        {
           //статические
           //скорость доп.
           Loco.temp_buffer = Loco.read_bytes((Int32)Loco.BA + 0x0032CA78, 2);
